...
public class XPopup {
     ...
     * 全局弹窗的设置
     **/
    private static int primaryColor = Color.parseColor("#3f74fd");
    ...
    public static class Builder {
         ...
         * @return
         */
        public ConfirmPopupView asConfirm(CharSequence title, int titleTextSize, int titleTextColor, CharSequence content, int contentTextSize, int contentTextColor,
                                          CharSequence cancelBtnText, int cancelTextSize, int cancelTextColor, CharSequence confirmBtnText,int confirmTextSize, int confirmTextColor,
            ...
            popupView.setTitleTextSize(titleTextSize);
            popupView.setTitleTextColor(titleTextColor);
            popupView.setContentTextSize(contentTextSize);
            popupView.setContentTextColor(contentTextColor);

            popupView.setCancelText(cancelBtnText);
            popupView.setCancelTextSize(cancelTextSize);
            popupView.setCancelTextColor(cancelTextColor);

            popupView.setConfirmText(confirmBtnText);
            popupView.setConfirmTextSize(confirmTextSize);
            popupView.setConfirmTextColor(confirmTextColor);
        ...
        public ConfirmPopupView asConfirm(CharSequence title, CharSequence content, CharSequence cancelBtnText, CharSequence confirmBtnText, OnConfirmListener confirmListener, OnCancelListener cancelListener, boolean isHideCancel) {
            ...
            ConfirmPopupView popupView = new ConfirmPopupView(this.context);
            popupView.setTitleContent(title, content, null);
            popupView.setTitleTextColor(-1);
            popupView.setContentTextColor(-1);
            popupView.setCancelText(cancelBtnText);
            popupView.setCancelTextColor(-1);
            popupView.setConfirmText(confirmBtnText);
            popupView.setConfirmTextColor(-1);
            popupView.setListener(confirmListener, cancelListener);
            if (isHideCancel) popupView.hideCancelBtn();
            popupView.popupInfo = this.popupInfo;
            return popupView;
