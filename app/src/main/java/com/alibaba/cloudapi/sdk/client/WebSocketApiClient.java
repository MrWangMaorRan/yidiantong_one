...
public class WebSocketApiClient extends BaseApiClient {
    ...
    public void init(WebSocketClientBuilderParams params){
        if(null == params){
            ...
            webSocketListener = new WebSocketListener() {
                ...
                public void onMessage(WebSocket webSocket, String text) {
                    if(null  == text || "".equalsIgnoreCase(text)) {
                        ...
                        try {
                            JSONObject receivedObject = JSON.parseObject(text);
                            ...
                            LogUtils.e("SDK" , "Call back occue error " + ex);
                        }
                ...
                public void onFailure(WebSocket webSocket, Throwable t, Response response) {
                    try {
                        ...
                        LogUtils.e("SDK" , "Failure block " + ex);
                    }
                 }
            };
        }
