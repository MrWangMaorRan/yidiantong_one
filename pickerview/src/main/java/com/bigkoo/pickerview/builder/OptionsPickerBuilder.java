...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setOutTextSize(int textSizeOut) {
    ...
    /**
     * Set item divider line type width.
     *
     * @param dividerWidth width.
     */
     ...
     * @param myItemHeight
     */
    public OptionsPickerBuilder setItemHeight(int myItemHeight) {
        WheelView.myItemHeight = myItemHeight;
        return this;
    }
