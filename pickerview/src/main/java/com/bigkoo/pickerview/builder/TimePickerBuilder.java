...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setOutTextSize(int textSizeOut) {
        mPickerOptions.textSizeOut = textSizeOut;
        return this;
    }
     ...
     * @param itemHeight
     */
    public TimePickerBuilder setItemHeight(int itemHeight) {
        WheelView.myItemHeight = itemHeight;
        return this;
    }
    ...
    /**
     * 是否格式化年的显示  今年，明年，后年，20XX...
     * @param isFormatYear
     * @return
     */
    public TimePickerBuilder setFormatYear(boolean isFormatYear) {
        mPickerOptions.isFormatYear = isFormatYear;
        return this;
    }
